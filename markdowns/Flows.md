...
**B. SIGN IN** [CLICK HERE FOR A VIDEO GUIDE](https://youtu.be/fxY4ISt0kpw)
...
(These are #1 and #2 metadata-property of the NFT) NFT Name can be a short identifier of the Image and NFT Description can be a short summary of the nature of the contents of the image with respect to the larger Collection 
